...
const Footer = () => {
    const links = [
        ...
        },
        {
            ...
            items: [{ name: "Cardiology", href: "/findDoctors" }, { name: "Dermatology", href: "/findDoctors" }, { name: "Neurology", href: "/findDoctors" }, { name: "Ophthalmology", href: "/findDoctors" },{ name: "Orthopedics", href: "/findDoctors" },{ name: "Pediatrics", href: "/findDoctors" }],
        },
    
        {
            title: "Services",
            items: [{ name: "Online Consultation" }, { name: "Health Records" }, { name: "Emergency Care"}],
        }
    ]
    ...
    return (
        <>
            ...
            <footer className="bg-blue-50 pt-15 px-4 sm:px-6 md:px-8 lg:px-20">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col lg:flex-row gap-16 pb-12">
                        <div className="flex-1 max-w-full lg:max-w-[400px]">
                            ...
                            <p className="text-sm leading-7 text-blue-400 mb-7 max-w-80">
                               Connecting patients with the best doctors. Book appointments online, consult via video, and manage your health records — all in one place.


                            </p>
                            <div className="flex gap-4 ">
                                <a href="#" className="size-9 rounded-full bg-blue-100 border border-blue-200 flex items-center justify-center hover:bg-blue-50 transition-colors">
                        ...
                        <div className="flex flex-wrap sm:flex-nowrap flex-1 justify-between gap-8 w-full max-w-3xl">
                            {links.map((link, index) => (
                                <div key={index}>
                                    <h3 className="text-base font-medium text-blue-800 mb-6">{link.title}</h3>
                                    <ul className="flex flex-col gap-3 list-none">
                                        {link.items.map((item, itemIndex) => (
                                            <li key={itemIndex}>
                                                <a href={item.href} className="text-sm text-blue-400 hover:text-blue-700 transition-colors">{item.name}</a>
                                            </li>
                                        ))}
                                    </ul>
                                </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 md:gap-16 py-9 max-w-6xl">
                        <div className="flex items-start gap-2.5 flex-1">
                            ...
                            <div>
                                <h4 className="text-base font-medium text-blue-800 mb-0.5">Address</h4>
                                <p className="text-sm text-blue-400 leading-relaxed">42 MediCare Lane, Health District,<br />Mumbai 400001</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2.5 flex-1">
                            <div className="size-8 rounded-lg bg-blue-100 border border-blue-200 flex items-center justify-center">
                            ...
                            <div>
                                <h4 className="text-base font-medium text-blue-800 mb-0.5">Phone</h4>
                                <p className="text-sm text-blue-400 leading-relaxed">+91 98765 43210</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2.5 flex-1">
                            <div className="size-8 rounded-lg bg-blue-100 border border-blue-200 flex items-center justify-center">
                            ...
                            <div>
                                <h4 className="text-base font-medium text-blue-800 mb-0.5">Email</h4>
                                <p className="text-sm text-blue-400 leading-relaxed">support@medicare.health</p>
                            </div>
                        </div>
                    </div>

                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 py-4 border-t border-blue-300">
                        <p className="text-sm text-blue-400">&copy; {new Date().getFullYear()}MediCare. All Rights Reserved. | Care, Trust & Technology in one place.</p>
                        <div className="flex flex-wrap justify-center gap-5 md:gap-9">
                            <a href="" className="text-sm text-blue-400 hover:text-blue-700 transition-colors">Privacy Policy</a>
                            <a href="" className="text-sm text-blue-400 hover:text-blue-700 transition-colors">Terms of Service</a>
                            <a href="/about" className="text-sm text-blue-400 hover:text-blue-700 transition-colors">About Us</a>
                            <a href="/contact" className="text-sm text-blue-400 hover:text-blue-700 transition-colors">Contact Us</a>
                        </div>
                    </div>
                </div>
            </footer>
